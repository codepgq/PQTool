...

{
    ...
    if (count <= 1) {
        ...
        for (size_t i = 0; i < count; i++) {
            ...
            NSTimeInterval frameDuration = [self sd_frameDurationAtIndex:i source:source];
...

{
    ...
    if (imagePath) {
        ...
        return [self imageWithGIFData:imageData];
...

{
    ...
    dispatch_async(dispatch_get_global_queue(0, 0), ^{
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            PQGIFImageBlock([self imageWithGIFData:CIFData]);
